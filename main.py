...
def main():
    ...
    metro_map = MGB.build()
    path = MetroRouter(metro_map, source='Federal Triangle', target='Farragut North', dep_time='08:00:00', k=5, disruptions=dm)()
    print("Đường đi:")
    print(path)
    path_2 = MetroRouter(metro_map, source='Eastern Market', target='Judiciary Sq', dep_time='08:00:00', k=5)()
    print("Đường đi 2:")
    print(path_2)
